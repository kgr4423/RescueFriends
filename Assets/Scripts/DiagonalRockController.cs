...
public class DiagonalRockController : MonoBehaviour {
	...
	void Start () {
        // 変数の初期化
		this.size = 2.0f + 2.0f * Random.value;
		this.fallSpeedX = 10.0f + 20.0f * Random.value;
		this.fallSpeedY = -70.0f + 140.0f * Random.value;
